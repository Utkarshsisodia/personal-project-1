  ...
  return (
    <section className="py-24 mb-10 pb-40 bg-background">
      <div className="container mx-auto px-4 md:px-8">
        ...
        {/* Bento Grid Layout - Increased row height to fit images beautifully */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[320px]">
          
          {/* Feature 1: Wide Card */}
          <Card className="md:col-span-2 overflow-hidden flex flex-col relative group bg-muted/30">
            {/* Restricted width so text doesn't overlap the image on desktop */}
            <CardHeader className="relative z-10 md:w-[55%]">
              <Zap className="h-8 w-8 text-amber-500 mb-2" />
              <CardTitle className="text-2xl">Lightning Fast Performance</CardTitle>
              <CardDescription className="text-base">
                Built on a modern edge network, our platform ensures your application responds in milliseconds, no matter where your users are located.
              </CardDescription>
            </CardHeader>
            {/* Dashboard Image */}
            <img 
          ...
          <Card className="md:col-span-1 md:row-span-2 overflow-hidden flex flex-col relative group bg-muted/30">
            <CardHeader className="relative z-10">
              ...
              <CardDescription className="text-base">
                Your data is protected by enterprise-level encryption, continuous monitoring, and automated threat detection systems.
              </CardDescription>
            </CardHeader>
            {/* Security/Code Image */}
          ...
          <Card className="overflow-hidden relative flex flex-col group bg-muted/30">
            <CardHeader className="relative z-10 pb-0">
              ...
              <CardDescription>
                Flawless responsive design that looks and feels native on any screen size.
              </CardDescription>
            </CardHeader>
            {/* Mobile App Image */}
          ...
          <Card className="overflow-hidden relative flex flex-col group bg-muted/30">
            <CardHeader className="relative z-10 pb-0">
              ...
              <CardDescription>
                Real-time insights and beautiful charts to help you make data-driven decisions.
              </CardDescription>
            </CardHeader>
            {/* Charts Image */}
            <div className="flex-1 relative mt-6 min-h-[140px]">
