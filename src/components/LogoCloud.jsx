      ...
      <div className="container mx-auto px-4 md:px-8 text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-10 md:gap-16 lg:gap-24">
          ...
          <div className="flex items-center gap-3 text-foreground/50 grayscale hover:grayscale-0 hover:text-foreground transition-all duration-300 cursor-pointer">
            {/* PASTE YOUR SVG HERE. Make sure to add className="h-8 w-auto" so it scales correctly */}
          ...
          {/* Logo 2: Custom SVG */}
          <div className="flex items-center gap-3 text-foreground/50 grayscale hover:grayscale-0 hover:text-foreground transition-all duration-300 cursor-pointer">
            <svg className="h-8 w-auto text-rose-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Logo 3: Custom SVG */}
          <div className="flex items-center gap-3 text-foreground/50 grayscale hover:grayscale-0 hover:text-foreground transition-all duration-300 cursor-pointer">
            <svg className="h-8 w-auto text-emerald-500" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Logo 4: Custom SVG */}
          <div className="flex items-center gap-3 text-foreground/50 grayscale hover:grayscale-0 hover:text-foreground transition-all duration-300 cursor-pointer">
            <svg className="h-8 w-auto text-amber-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
