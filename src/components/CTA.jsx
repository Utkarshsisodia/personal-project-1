        ...
        <div className="relative overflow-hidden rounded-3xl border bg-background px-6 py-24 text-center shadow-sm isolate">
          ...
          <div className="relative z-10 mx-auto max-w-3xl flex flex-col items-center">
            ...
            <h2 className="text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl md:text-6xl mb-6">
              Build your next idea <br className="hidden sm:block" /> faster
              than ever.
            </h2>

            <p className="text-lg text-muted-foreground mb-10 max-w-2xl leading-relaxed">
              Stop reinventing the wheel. Use our robust, accessible, and highly
              customizable UI blocks to ship your application in record time.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Button
                size="lg"
                className="h-12 px-8 text-base rounded-lg shadow-md hover:shadow-lg transition-all"
              >
                Start Building Free
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="h-12 px-8 text-base rounded-lg group bg-background"
              >
                Read Documentation
